...
# resnet18_model.fc = nn.Linear(512, 10)这里修改，增加dropout层
...
# 日志与训练参数
writer = SummaryWriter("./logs_improve_resnet18")
total_train_step = 0
total_test_step = 0
epoch = 20
...
for i in range(epoch):
    ...
    torch.save(resnet18_model, f"model_save/resnet18_improve_epoch{i}.pth")
